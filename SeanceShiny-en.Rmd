...
- shinyapps.io or connect.posit.cloud -> account creation
...
- use the load function to load Rdata files

Even best use the arrow package and store data as parquet files :
