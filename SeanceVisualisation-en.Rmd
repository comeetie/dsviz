...
<img src="./images/choro.jpeg" height="400px">

color scheme + discretisation 

## Color scales
https://colorbrewer2.org

<img src="./images/hcl.png" height="400px">

color scheme + interpolation (! color space)
...
<img src="./images/parallel.png" height="400px">
...
<img src="./images/violin.png" height="400px">
...
## {background-image="./images/tufteP.jpg" background-opacity="0.2"}
<h2 class="r-fit-text mhead">Tufte</h2>
<h2 class="r-fit-text mhead">Data-ink ratio</h2>
<h2 class="r-fit-text mhead">Lying factor</h2>
...
<li> (+ optional) add statistical transformation
<li> (+ optional) change scale options
<li> (+ optional) specify title, theme, guides, style ...
</ul>
<br><br>
