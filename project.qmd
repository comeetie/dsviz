...
- The data that you will use for this study are available trought  the STIF open data portal :
    - [validation per day and stop point first semester of 2025](https://data.iledefrance-mobilites.fr/explore/dataset/validations-reseau-ferre-nombre-validations-par-jour-1er-trimestre/information/), [validation per day and stop point second semester of 2025](https://data.iledefrance-mobilites.fr/explore/dataset/validations-reseau-ferre-nombre-validations-par-jour-2eme-trimestre/information/)
    - [validation per day and stop point 2015 - 2024](https://data.iledefrance-mobilites.fr/explore/dataset/histo-validations-reseau-ferre/information/)
...
- You may select a subsample of the dataset or aggregate it to solve size problems.
- Deploy the Shiny dashboard on shinyapps.io for accessibility and user interaction.
...
8 January 2026 by e-mail at etienne.come[at]univ-eiffel.fr !!
